...
export class UpdateVariantDto {
  ...
  /**
   * Assembly charges for the product variant
   */
  @ApiProperty({
    description: 'Assembly charges for the product in dollars',
    example: 50.0,
    required: false,
  })
  @IsOptional()
  ...
  /**
   * Estimated delivery time for the product variant
   */
  @ApiProperty({
    description: 'Estimated delivery time for the product variant (string, e.g., "3–5 days")',
    example: '3–5 days',
    required: false,
  })
  @IsOptional()
  ...
  /**
   * Material composition and construction info
   */
  @ApiProperty({
    description: 'Material composition and construction info',
    required: false,
    nullable: true,
  })
  @IsOptional()
